...
function setup() {
  ...
  fill(255, 204);
  noStroke();
  r1 = new MRect(1, 134.0, 0.532, 0.1 * height, 10.0, 1);
  r2 = new MRect(20, 44.0, 0.166, 0.4 * height, 5.0, 1);
  r3 = new MRect(20, 58.0, 0.332, 0.2 * height, 10.0, 1);
  r4 = new MRect(10, 120.0, 0.0498, 0.2 * height, 10.0, 1);
